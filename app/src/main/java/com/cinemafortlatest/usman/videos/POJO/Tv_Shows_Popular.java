...
public class Tv_Shows_Popular
{
    private Tv_Shows_Popular_Results[] results;
    ...
    public Tv_Shows_Popular_Results[] getResults ()
    {
        return results;
    }

    public void setResults (Tv_Shows_Popular_Results[] results)
    {
