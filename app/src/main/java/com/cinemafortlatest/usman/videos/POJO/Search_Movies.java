...
public class Search_Movies
{
    private Search_Movie_Results[] results;
    ...
    public Search_Movie_Results[] getResults ()
    {
        return results;
    }

    public void setResults (Search_Movie_Results[] results)
    {
