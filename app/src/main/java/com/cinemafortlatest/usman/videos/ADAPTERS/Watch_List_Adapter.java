...
public class Watch_List_Adapter extends RecyclerView.Adapter <Watch_List_Adapter.Movie_holder>{

    Context context;
    List<Realm_Watch_List> list;
    Listener listener;
    public Watch_List_Adapter(Context context, List<Realm_Watch_List> list, Listener listener)
    {
    ...
    public void onBindViewHolder(Movie_holder holder, final int position) {
        Realm_Watch_List movie=list.get(position);
