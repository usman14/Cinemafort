...
public class Popular_People
{
    private Popular_People_Results[] results;
    ...
    public Popular_People_Results[] getResults ()
    {
        return results;
    }

    public void setResults (Popular_People_Results[] results)
    {
